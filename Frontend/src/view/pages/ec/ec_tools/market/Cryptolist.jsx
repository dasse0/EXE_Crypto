     ...
     >
      ...
      >
       ...
       >
        ...
        <button
         onClick={() => {
          const symbolSorted = [...userlist].sort((a, b) => a.name > b.name);
          setUserList(symbolSorted);
         }}
        >
         &#8593;
     ...
     {userlist.map((user) => (
      ...
      >
       ...
       <td
        style={{
         backgroundColor:
          user.price_change_percentage_7d_in_currency < 0 ? "darkred" : "blue",
        }}
       >
       ...
       <td
        style={{
         backgroundColor:
          user.price_change_percentage_14d_in_currency < 0 ? "darkred" : "blue",
        }}
       >
       ...
       <td
        style={{
         backgroundColor:
          user.price_change_percentage_30d_in_currency < 0 ? "darkred" : "blue",
        }}
       >
       ...
       <td
        style={{
         backgroundColor:
          user.price_change_percentage_1y_in_currency < 0 ? "darkred" : "blue",
        }}
       >
