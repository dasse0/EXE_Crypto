...
import {
  ...
  DOMFONTSIZE,
  binance_symbol_3,
  DOM_3_Binance_Trade_Quantity_Filter,
  DOM_3_BinanceQuantityFilter_low,
  DOM_3_BinanceQuantityFilter_high,
  DOM_3_Binance_Trade_Quantity_Filter_Highlight,
...
export default function Binance_USDT_2() {
  ...
  const dataws = () => {
    const depth = new WebSocket(
      "ws://localhost:8080/binance/ws/depth/" + binance_symbol_3
    );
    const wss_aggTrade = new WebSocket(
      "ws://localhost:8080/binance/ws/aggtrade/" + binance_symbol_3
    );

    const ticker = new WebSocket(
      "ws://localhost:8080/binance/ws/ticker5s/" + binance_symbol_3
    );
    ...
    wss_aggTrade.addEventListener("message", (event) => {
      ...
      JSON.stringify(data);
      const quantity =
        data.q > DOM_3_Binance_Trade_Quantity_Filter ? data.q : null;
    ...
    <>
      ...
      >
        <div>
          <input
            type="text"
            placeholder={binance_symbol_3}
            onChange={(e) => {
              localStorage.setItem("Binance_Symbol_USDT_DOM_3", e.target.value);
            }}
            style={{
        ...
        >
          ...
          <Tab eventKey="options" title="Settings">
            <TabContent className="Tab-DOM-3-Settings">
              ...
              <input
                type="number"
                placeholder={DOM_3_BinanceQuantityFilter_high}
                inputMode="numeric"
                onChange={(e) => {
              ...
              <input
                type="number"
                placeholder={DOM_3_BinanceQuantityFilter_low}
                onChange={(e) => {
                  localStorage.setItem(
                    "DOM_3_BinanceQuantityFilter_low",
                    e.target.value
              ...
              <input
                type="number"
                placeholder={DOM_3_Binance_Trade_Quantity_Filter}
                onChange={(e) => {
                  localStorage.setItem(
                    "DOM_3_Binance_Trade_Quantity_Filter",
                    e.target.value
              ...
              <input
                type="number"
                placeholder={DOM_3_Binance_Trade_Quantity_Filter_Highlight}
                onChange={(e) => {
                  localStorage.setItem(
                    "DOM_3_Binance_Trade_Quantity_Filter_Highlight",
                    e.target.value
