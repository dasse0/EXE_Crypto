...
class Binance_Symbol_USDT_Chart_1 extends React.Component {
  ...
  componentDidMount() {
    ...
    const chart = LightweightCharts.createChart(
      ...
      {
        width: getSelection(document.querySelector(".BinanceCandlestickChart_1"))
          .width,

        height: getSelection(document.querySelector(".BinanceCandlestickChart_1"))
          .height,
    ...
    const socket = new WebSocket(
      "ws://localhost:8080/binance/ws/kline1m/" + binance_symbol_1
    );
    ...
    //get historical data
    fetch(
      "https://fapi.binance.com/fapi/v1/klines?symbol=" + binance_symbol_1 + "&interval=1m&limit=1000" 
    )
  ...
  render() {
    return (
      <div>
        ...
        <div className="BinanceCandlestickChart_1"></div>
      </div>
    );
  }
}
