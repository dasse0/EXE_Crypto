...
const bybit_ws_spot_marketdata = require("./market_data/spot/bybit_ws_spot_marketdata");
...
async function bybit_ws_spot_marketdata_src(fastify) {
  bybit_ws_spot_marketdata.bybit_ws_spot_depth(fastify);
}

async function bn_src(fastify) {
  binance_ws_usdt_marketdata_src(fastify);
  binance_ws_spot_marketdata_src(fastify);
  bybit_ws_spot_marketdata_src(fastify);
}
